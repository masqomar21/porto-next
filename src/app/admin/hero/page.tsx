...
export default function HeroAdminPage() {
  ...
  return (
    <div className="space-y-6 w-full animate-in fade-in duration-300">
      ...
      <form
        onSubmit={handleSave}
        className="space-y-6 bg-card border border-border p-6 rounded-md shadow-xs"
      >
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex flex-wrap gap-2 p-3 bg-muted/40 border-0 border-b border-border/60 rounded-none min-h-[48px] items-center">
            {data.roles.map((r) => (
              <span
                key={r}
                className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-foreground text-background font-mono rounded-xs text-xs font-semibold"
              >
                {r}
                <button
                  type="button"
          ...
          <span className="text-[10px] font-mono text-muted-foreground block mt-1">
            Press Enter to add each role. These cycle in the homepage typewriter
            animation.
          </span>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            value={data.tagline}
            onChange={(e) =>
              setData((p) => ({ ...p, tagline: e.target.value }))
            }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) =>
                setData((p) => ({ ...p, ctaPrimaryLabel: e.target.value }))
              }
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) =>
                setData((p) => ({ ...p, ctaPrimaryUrl: e.target.value }))
              }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) =>
                setData((p) => ({ ...p, ctaSecondaryLabel: e.target.value }))
              }
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) =>
                setData((p) => ({ ...p, ctaSecondaryUrl: e.target.value }))
              }
              placeholder="/blog"
            />
          </div>
        ...
        {toast && (
          <div
            className={`p-3 rounded-none font-mono text-xs border ${
              toast.type === "success"
