...
export default function EditProjectPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (res.ok) setToast({ type: 'success', msg: 'Project saved!' });
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div>
        <h1 className="text-3xl font-extrabold tracking-tight text-foreground">Edit Project</h1>
        <p className="text-muted-foreground text-sm mt-1">Modify your project showcase item details</p>
      </div>
